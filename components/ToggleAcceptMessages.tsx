...
const ToggleAcceptMessages = ({ isAcceptingMessages }: { isAcceptingMessages: boolean }) => {
   ...
   return (
      <div className="flex items-center justify-between space-x-2 mt-6 bg-neutral-900 border px-4 py-2 rounded-md">
         <Label htmlFor="toggle-accept-messages" className={"text-lg text-neutral-200 text-base"}>
            Accept Messages
         </Label>
