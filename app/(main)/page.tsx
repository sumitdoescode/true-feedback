         ...
         <Container>
            <div className="max-w-4xl mx-auto">
                              ...
                              <CarouselItem key={id} className="w-full">
                                 <Card>
                                    ...
                                    <CardContent className="flex items-center gap-4">
                                       ...
                                       <div>
                                          <p className="text-base md:text-lg font-medium text-neutral-300">{content}</p>
               ...
               <div className="flex items-center justify-center">
                  <Link href="/login">
                     <Button className={"text-base w-xl mx-auto rounded-full mt-12"} size={"lg"} variant={"default"}>
                        Get Started
                     </Button>
                  </Link>
               </div>
